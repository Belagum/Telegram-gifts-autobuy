...
PatternSpec = tuple[str, str] | tuple[str, str, re.RegexFlag]

SENSITIVE_PATTERNS: list[PatternSpec] = [
    ...
    (
        r"(api[_-]?hash\s*[:=]\s*['\"]?)([a-zA-Z0-9_\-]{20,})(['\"]?)",
        r"\1***REDACTED***\3",
    ),
    (
    ...
    (
        r"(bot[_-]?token\s*[:=]\s*['\"]?)([0-9]+:[a-zA-Z0-9_\-]{30,})(['\"]?)",
        r"\1***REDACTED***\3",
    ),
    # Passwords
    (
